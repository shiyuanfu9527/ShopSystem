			...
			<div class="row">
				<c:if test="${not empty requestScope.product}">
					...
					<div style="margin: 0 auto; width: 950px;">
						<div class="col-md-6">
							<a href="product_info.jsp?id=${product.id}"> <img
								src="${product.pImage}" alt="${product.pName}" width="170"
						...
						<div class="col-md-6">
							...
							<div style="margin: 10px 0 10px 0;">
								会员价: <strong style="color: #ef0101;">￥：${product.iPrice}</strong>
								市场价：
							...
							<div
								...
								<form action="AddShopCart" method="post" id="myForm"target="nm_iframe">
								    <input name="cId" type="hidden" value="${sessionScope.customer.id}"/>
								    <input name="pId" type="hidden" value="${product.id}"/>
								    <input name="pName" type="hidden" value="${product.pName}">
								    <input name="pImage" type="hidden" value="${product.pImage}">
								    <input name="iPrice" type="hidden" value="${product.iPrice}">
